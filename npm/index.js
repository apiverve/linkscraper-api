...
class linkscraperWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/linkscraper');
        }
        ...
        this.validationRules = {"url":{"type":"string","required":true,"format":"url"},"maxlinks":{"type":"number","required":true,"default":"50"},"includequery":{"type":"boolean","required":false,"default":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/linkscraper`);
        }
    }
...
module.exports = linkscraperWrapper;
