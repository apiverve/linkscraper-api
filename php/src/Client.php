...
namespace APIVerve\Linkscraper;
...
/**
 * Client for the Link Scraper API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://linkscraper.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/linkscraper';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LinkscraperClient] {$message}\n";
        }
    }
}
