...
```gradle
dependencies {
    implementation 'com.github.apiverve:linkscraper-api:1.1.12'
}
```
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/linkscraper](https://docs.apiverve.com/ref/linkscraper)
...
- **Documentation:** [https://docs.apiverve.com/ref/linkscraper](https://docs.apiverve.com/ref/linkscraper)
- **Issues:** [GitHub Issues](https://github.com/apiverve/linkscraper-api/issues)
