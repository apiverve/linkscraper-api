// Package linkscraper provides a Go client for the Link Scraper API.
//
// For more information, visit: https://linkscraper.apiverve.com?utm_source=go&utm_medium=readme
package linkscraper
...
// Request contains the parameters for the Link Scraper API.
//
// Parameters:
//   - url (required): string - The URL of the web page to scrape links from [format: url]
//   - maxlinks (required): number - Maximum number of links to scrape and return
//   - includequery: boolean - Include query strings in the scraped links
type Request struct {
	Url string `json:"url"` // Required
	Maxlinks int `json:"maxlinks"` // Required
	Includequery bool `json:"includequery,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"includequery": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Link Scraper API.
