...
namespace APIVerve.API.LinkScraper
{
    ...
    /// <summary>
    /// Client for the LinkScraper API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "maxlinks", new ValidationRule { Type = "number", Required = true } },
            { "includequery", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        private void ValidateParams(LinkScraperQueryOptions options)
        {
